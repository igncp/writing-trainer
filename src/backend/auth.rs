...
use super::env::{
    ENV_BASE_URL, ENV_CLIENT_ORIGIN, ENV_GOOGLE_CLIENT_ID, ENV_GOOGLE_CLIENT_SECRET,
    ENV_JWT_SECRET, ENV_TOKEN_MAXAGE,
};
...
impl AuthConfig {
    pub fn new() -> AuthConfig {
        ...
        let google_oauth_redirect_url_base =
            std::env::var(ENV_BASE_URL).expect("ENV_BASE_URL must be set");
